export type SourceId = "local" | "youtube" | "soundcloud" | "spotify" | "link";
export type RemoteSourceId = Exclude<SourceId, "local" | "link">;
...
export interface Track {
  ...
  spotifyId?: string;
  /** Optional tags discovered by the local scanner. */
  genre?: string;
  artworkPath?: string;
  /** Used by incremental scans and duplicate detection. */
  fileSize?: number;
